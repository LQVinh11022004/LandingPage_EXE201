...
const ServicePackage = () => {
  ...
  const fetchServicePackages = async (newPageIndex = pageIndex) => {
    ...
    try {
      const response = await fetch(`https://momandbaby-exe201.onrender.com/api/service-package?${queryParams}`, {
        method: 'GET',
        headers: {
  ...
  const createServicePackage = async (body) => {
    ...
    try {
      const response = await fetch(`https://momandbaby-exe201.onrender.com/api/service-package`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateServicePackage = async (id, body) => {
    ...
    try {
      const response = await fetch(`https://momandbaby-exe201.onrender.com/api/service-package/${id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
